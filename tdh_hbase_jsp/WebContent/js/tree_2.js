...
function tree(objName,path) {
	...
	this.icon = {
		...
		root				: path + 'images/tree/closedfolder.gif',

		folder			: path + 'images/tree/closedfolder.gif',

		folderOpen	: path + 'images/tree/openfolder.gif',

		node				: path + 'images/tree/closedfolder.gif',
