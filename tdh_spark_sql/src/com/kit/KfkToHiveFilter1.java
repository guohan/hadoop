...
public final class KfkToHiveFilter1 {
	private static final Pattern SPACE = Pattern.compile(" ");
	private static Logger logger = Logger.getLogger(KfkToHiveFilter1.class);
	...
	public static void main(String[] args) throws IOException {
		...
		InputStream is = KfkToHiveFilter1.class.getClassLoader()
