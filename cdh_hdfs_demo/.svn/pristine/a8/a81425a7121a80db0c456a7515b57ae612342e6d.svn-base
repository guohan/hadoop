...
public class SecondTest extends Configured implements Tool{  
    ...
    public int run(String[] args) throws Exception {  
        ...
        FileInputFormat.addInputPath(job, new Path("hdfs://172.16.19.158:8020/tmp/log.txt"));  
        FileOutputFormat.setOutputPath(job, new Path("hdfs://172.16.19.158:8020/tmp/logs/logresult.txt"));       
