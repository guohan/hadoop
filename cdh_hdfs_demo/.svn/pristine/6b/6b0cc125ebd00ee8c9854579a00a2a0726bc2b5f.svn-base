...
//        conf.set("yarn.resourcemanager.scheduler.address", "192.168.1.100:8030");
        ...
        otherArgs[0] = "hdfs://172.16.19.158:8020/guohan/wordcountdata.txt";//计算原文件目录，需提前在里面存入文件

        String time = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());

        otherArgs[1] =new Path("hdfs://172.16.19.158:8020/guohan/output") + time;//计算后的计算结果存储目录，每次程序执行的结果目录不能相同，所以添加时间标签
        ...
        Job job = new Job(conf, "word_count_mapreduce");
