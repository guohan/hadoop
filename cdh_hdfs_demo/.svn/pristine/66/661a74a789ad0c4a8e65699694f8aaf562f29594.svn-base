...
//  conf.set("mapreduce.job.jar","D:\\hadoop.jar");
    ...
    FileInputFormat.addInputPath(job, new Path("hdfs://172.16.19.158:8020/guohan/test0817.txt"));//文件输入路径
    String time = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
    FileOutputFormat.setOutputPath(job, new Path("hdfs://172.16.19.158:8020/guohan/output"+time));//文件输出路径
