 ...
 *
 */
public class Dos_alarm_Warning {
...
//		    		WordCount.class.getClassLoader().getResource("hdfs.keytab").getPath());
		...
		otherArgs[0] = "hdfs://kit-b1:8020/user/discover/bigfile2.txt";// 计算原文件目录，需提前在里面存入文件

//		String time = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());

		otherArgs[1] = new Path("hdfs://kit-b1:8020/user/discover/output20170614dos001").toString();
