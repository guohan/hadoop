...
//			String sql5 = "create table SM_PRIV_MENU_USER (ID varchar(100), EIPID varchar(100), MENU_ID varchar(100), UPD_USER varchar(100),UPD_DATE varchar(100), CRT_USER varchar(100), CRT_DATE varchar(100)) clustered by (ID) into 10 buckets stored as orc TBLProperties(\"transactional\"=\"true\")";
//			st.execute(sql2);
			
			String sql5 = "create table DIM_LCAM_PROJECT_TYPE (PROJECT_TYPE_ID varchar(100), PROJECT_TYPE_NAME varchar(100), UNIFIED_CODE varchar(100), SORT varchar(100)) clustered by (PROJECT_TYPE_ID) into 10 buckets stored as orc TBLProperties(\"transactional\"=\"true\")";
...
//		String sql1 = "Insert into kfktohiveTable(topic, key,value) values ('topic2', '12','23_value')";
//		String sql3 = "set transaction.type=inceptor";
//		try {
//			conn = JDBCUtils.getConnection();
//			st = conn.createStatement();
