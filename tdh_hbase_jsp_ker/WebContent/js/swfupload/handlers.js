...
function swfUploadLoaded() {
	...
	//document.getElementById("btnCancel").onclick = function () { self.selectFile();};
...
function uploadSuccess(file, serverData) {
	...
	try {
		if(isSuccess){
			...
			document.getElementById("fileName").value = document.getElementById("fileName").value + "&&" + file.name;
			document.getElementById("serverFileName").value = document.getElementById("serverFileName").value + "&&" + serverData;
		}else{
			var tr = document.getElementById(file.id);
			tr.style.color="red";
			var bar = document.getElementById(file.id+"_bar");
