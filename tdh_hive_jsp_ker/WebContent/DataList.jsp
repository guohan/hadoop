...
<th style="text-align: center; width: 10%">CLASSIFY_ID</th>
<th style="text-align: center; width: 10%">CLASSIFY_NAME</th>
<th style="text-align: center; width: 10%">YEAR_MTH_ID</th>
<th style="text-align: center; width: 10%">IN_AMT</th>
<th style="text-align: center; width: 10%">IN_QTY</th>
<th style="text-align: center; width: 10%">OUT_AMT</th>
<th style="text-align: center; width: 10%">OUT_QTY</th>
<th style="text-align: center; width: 10%">UNIT_NAME</th>
</tr>
...
<c:forEach items="${list}" var="bean" > 
  <tr align=center>
    <td><c:out value="${bean.ROW_ID}"/></td>
       ...
       <td><c:out value="${bean.YEAR_MTH_ID}"/></td>
       <td><c:out value="${bean.IN_AMT}"/></td>
       <td><c:out value="${bean.IN_QTY}"/></td>
       <td><c:out value="${bean.OUT_AMT}"/></td>
       <td><c:out value="${bean.OUT_QTY}"/></td>
       <td><c:out value="${bean.UNIT_NAME}"/></td>
   </tr>
</c:forEach>
</table>
</body>
