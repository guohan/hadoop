...
while(i>0)
{
	...
	if(i==1)
	{
		document.write("<INPUT position='UP' id='OB_Button1' onDblClick='OutlookLikeBar.FolderClicked("+i+");this.blur()' onClick='OutlookLikeBar.FolderClicked("+i+");this.blur()' TYPE='button' value='"+Folder[0]+"' style=\"position:absolute;top:0;left:0;width:150;height:"+OB_ButtonHeight+";font-size:"+OB_ButtonFontSize+"pt;cursor:hand;color:"+OB_ButtonFontColor+"; border-width:0; background-color: #2159DA; background-image:url('images/menu/across.gif')\">");
		MakeItems(Folder,i,OB_ButtonHeight);		
	}	
	else
	{
		document.write("<INPUT position='DOWN' id='OB_Button"+i+"' onDblClick='OutlookLikeBar.FolderClicked("+i+");this.blur()' onClick='OutlookLikeBar.FolderClicked("+i+");this.blur()' TYPE='button' value='"+Folder[0]+"' style=\"position:absolute;top:"+(OB_Height-(j-i)*OB_ButtonHeight-OB_BorderWidth*2)+";left:0;width:150;height:"+OB_ButtonHeight+";font-family:"+OB_ButtonFontFamily+";font-size:"+OB_ButtonFontSize+"pt;cursor:hand;color:"+OB_ButtonFontColor+"; border-width:0; background-color: #2159DA; background-image:url('images/menu/across.gif')\">");
...
function MakeItems(Folder,zorder,top)
{
	...
	for(var i=1;i<items*4;i+=4)
	{
		...
		document.write("</div>");
		document.write("<div align='center' style='width=150;position:absolute;top:"+(OB_LabelMargin+OB_IconsHeight+OB_Margin+Math.ceil((i-1)/4)*(OB_ItemsSpacing+OB_LabelFontSize+OB_IconsHeight))+";font-family:"+OB_LabelFontFamily+";font-size:"+OB_LabelFontSize+"pt;color:"+OB_LabelFontColor+"'>");
...
//		document.write(item.link,item.targetFrame);
